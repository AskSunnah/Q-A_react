// src/components/ReadBook/Sidebar.jsx
import React from "react";

export default function Sidebar({ chapters, setCurrentPage, pages, tocLabel }) {
  // Flatten chapter to find first page for each chapter
  return (
