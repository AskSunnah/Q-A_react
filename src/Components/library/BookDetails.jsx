              ...
              {activeSection === "details" && (
                <div>
                  ...
                  <div>
                    ...
                    <ul className={`list-none m-0 ${isRtl ? "pr-0" : "pl-0"}`}>
                      {book.chapters && book.chapters.length > 0 ? (
                        book.chapters.map((chapter, index) => {
                          ...
                          return (
                            <li
                              key={index}
                              className="mb-3 rounded-xl border border-[#f0e6bd] bg-[#fffdf7] hover:bg-[#fff8df] hover:border-[#d4af37] transition-all"
                            >
                              <Link
                                to={`/library/read/${lang}/${slug}?page=${firstPage}`}
                                className="block px-4 py-3 text-[#7a5a12] font-medium no-underline hover:text-[#4b3709]"
                              >
                                {chapter.title}
                              </Link>
                            </li>
              ...
              {activeSection === "author" && (
                <div>
                  ...
                  <div className="mb-5 rounded-2xl bg-[#fffaf0] border border-[#eadca3] px-5 py-4">
                    <span className="font-bold text-[#5c4712]">
                      {labels.author}:
                    </span>{" "}
