      ...
      <div className="max-w-[1180px] mx-auto">
        ...
        <div className="flex gap-3 flex-wrap mb-2">
          <QuickActionButton
            icon={PlusCircle}
            label="Add Q&A"
            onClick={() => navigate("/supervised/add-qa")}
          />
          <QuickActionButton
            icon={BookPlus}
            label="Add Book"
          ...
          {loading ? (
            ...
            <>
              ...
              <StatCard
                ...
                onClick={() => navigate("/supervised/reports")}
              />
            </>
          )}
        </div>
          ...
          {loading ? (
            ...
            <>
              <StatCard
                ...
                icon={Library}
                color="#c3a421"
                onClick={() => navigate("/supervised/all-books")}
              />
              <StatCard
                ...
                icon={FileText}
                color="#16a34a"
                onClick={() => navigate("/supervised/all-qa")}
              />
              <StatCard
                ...
                icon={MessageSquare}
                color="#2563eb"
                onClick={() => navigate("/supervised/user-feedback")}
              />
            </>
          )}
        </div>
