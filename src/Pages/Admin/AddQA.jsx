...
function RelatedModal({
  ...
  const [checked, setChecked] = useState(() => {
    // only start with what's currently in relatedQuestions — respect removals
    return new Set(selected.map((r) => r.slug));
  });
  const [loading, setLoading] = useState(true);
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-[520px] max-w-[95vw] max-h-[85vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-3">
          {loading ? (
            ...
            <>
              {/* inline-referenced questions shown first with a badge */}
